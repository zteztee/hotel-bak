...
//            properties.setProperty("hadoop.home.dir", "E:\\springboot\\hadoop-common-2.7.3-bin-master");
            properties.setProperty("hadoop.home.dir", "D:\\TEST\\Tools\\hadoop-3.1.1");

            // zookeeper集群的URL配置信息
            configuration.set("hbase.zookeeper.quorum", "node2,node3,node4,node1");
            // HBase的Master
            configuration.set("hbase.master.port", "61000");
            // 客户端连接zookeeper端口
     ...
     * @return
     */
    public static ResultScanner get(String tablename, Object age) throws IOException {
        Table table = null;
